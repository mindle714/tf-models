...
#model = wav2vec2_phone(num_class=1251, use_last=False, use_layers=3,
#model = wav2vec2_phone(num_class=1251, use_last=False, use_layers=12,
model = wav2vec2_phone(num_class=1251, use_last=True, use_layers=12,
...
#ckpt.write("wav2vec2_vox.ckpt")
#ckpt.write("wav2vec2_vox_v2.ckpt")
ckpt.write("wav2vec2_vox_v3.ckpt")
