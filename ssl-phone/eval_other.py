...
if timit:
  sys.exit("use eval.py for timit model")
else:
  args.eval_list = "/data/hejung/librispeech/test-other.flac.phone"
...
if True:
  ...
  with open(join("results_other", "{}.eval".format(resname)), "w") as f:
