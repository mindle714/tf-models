...
class tera_unet(tf.keras.layers.Layer):
  ...
  def build(self, input_shape):
    ...
    self.prj2 = conv1d(256, 4, strides=2, **conv_opt, name='prj2_frozen')
    self.prj3 = conv1d(64, 4, strides=2, **conv_opt, name='prj3_frozen')
    self.prj4 = conv1d(64, 4, strides=2, **conv_opt, name='prj4_frozen')
    self.prj5 = tf.keras.layers.Dense(64, use_bias=True, name='prj5_frozen')
