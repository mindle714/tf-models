...
parser.add_argument('--as_norm', dest='as_norm', action='store_true')
parser.add_argument('--norm_v2', dest='norm_v2', action='store_true')
parser.add_argument('--n_cohort', type=int,   default=1000)
parser.add_argument('--cohort_path',  type=str,   default="cohort.npy",                                     help='Path to save the score.txt and models')
...
if args.eval == True:
	...
	EER, minDCF = s.eval_network(eval_list = args.eval_list, eval_path = args.eval_path, as_norm = args.as_norm, norm_v2 = args.norm_v2, cohort_path = args.cohort_path, num_cohort = args.n_cohort)
